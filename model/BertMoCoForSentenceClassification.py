...
class BertMoCoForSentenceClassificationBert(BertPreTrainedModel):
...
class BertMoCoForSentenceClassificationDistbert(DistilBertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
...
class BertMoCoForSentenceClassificationDeberta(DebertaV2PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
